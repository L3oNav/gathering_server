...
class RefiningProfit:
    ...
    def __init__(self, resources, prices, prices_refined, fee_percentage, focus_from=6, focus=30000):
    ...
    def _profit_estimated(self, refined_price, resources_cost, product_value):
        return (refined_price - resouces_cost + (resources_cost / 100 * self.return_rate)-_fee(product_value))
